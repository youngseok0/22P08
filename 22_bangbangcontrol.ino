...
// Servo adjustment
#define _DUTY_MAX 1880  // Servo angle: D degree
#define _DUTY_NEU 1287  // Servo angle: 0 degree
#define _DUTY_MIN 695   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 72 // Replace with |D - E| degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return (415+(-1.11*a_value) + ((7.29e-04) * a_value * a_value));
}
